...
pub use fragment::{
    ...
    PasteFragmentSetIdentityRemapV1, PasteFragmentSetResultV1, PasteFragmentSetV1,
    PasteFragmentV1, PasteIdentityRemapV1, RectangleFragmentEntityV1,
    SINGLE_RECTANGLE_ENTITY_ID_V1, TranslationEmuV1, capture_rectangle_fragment_set_v1,
    capture_rectangle_fragment_v1, materialize_paste_fragment_set_v1,
    materialize_paste_fragment_v1,
};
