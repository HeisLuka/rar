use pub_editor::{
    ...
    EDITOR_PROJECT_VERSION_V0_10, EDITOR_PROJECT_VERSION_V0_11, EDITOR_PROJECT_VERSION_V0_12, EditOperation, EditorError,
...
#[test]
fn current_project_schema_advances_to_v0_12_without_erasing_prior_versions() {
    assert_eq!(EDITOR_PROJECT_VERSION_CURRENT, EDITOR_PROJECT_VERSION_V0_12);
    assert_eq!(EDITOR_PROJECT_VERSION_V0_12, "pub-editor-v0.12");
